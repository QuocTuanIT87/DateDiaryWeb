...
export const OnboardingView: React.FC = () => {
  ...
  // User states
  const [user1, setUser1] = useState<DateUser>(
    createEmptyUser("user_1", "Nam"),
  );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateUser(parsedUser2)) {
      try {
        ...
        setErrors({
          submit: "Đã xảy ra lỗi khi lưu thông tin. Vui lòng thử lại.",
        });
      } finally {
        setLoading(false);
      }
  ...
  const currentBgColor = isBoyStep
    ? "rgba(85, 150, 224, 0.08)"
    : "rgba(243, 104, 224, 0.08)";

  return (
    <div
      className="container animate-fade"
      style={{ paddingBottom: "40px", maxWidth: "600px", margin: "40px auto" }}
    >
      {/* Welcome Banner */}
      <div style={{ textAlign: "center", margin: "24px 0" }}>
        <h1
          style={{
            ...
            color: "var(--text)",
            background:
              "linear-gradient(45deg, var(--primary) 20%, var(--accent) 80%)",
        ...
        >
          Chào mừng các bạn đến với nhật ký tình yêu. Hãy thiết lập hồ sơ của cả
          hai để bắt đầu lưu trữ kỷ niệm!
        </p>
      </div>
      ...
      >
        ...
        >
          {isBoyStep ? "👦 Thông tin Bạn Nam" : "👧 Thông tin Bạn Nữ"}
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          ...
          <input
            ...
            placeholder={
              isBoyStep
                ? "Nhập tên bạn Nam (VD: Bạn Nam)"
                : "Nhập tên bạn Nữ (VD: Bạn Nữ)"
            }
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          ...
          <input
            ...
            onChange={(e) =>
              updateField(activeStep, "birthday", e.target.value)
            }
            style={{
              padding: "12px 14px",
              borderRadius: "var(--radius-md)",
              ...
              fontSize: "14px",
              color:
                (isBoyStep && !user1.birthday) ||
                (!isBoyStep && !user2.birthday)
                  ? "var(--text-muted)"
                  : "var(--text)",
            }}
            onFocus={(e) =>
              (e.target.style.borderColor = errors.birthday
                ? "var(--danger)"
                : currentThemeColor)
            }
            onBlur={(e) =>
        ...
        <div style={{ display: "flex", gap: "12px" }}>
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                updateField(activeStep, "height", e.target.value)
              }
              style={{
                padding: "12px 14px",
                borderRadius: "var(--radius-md)",
              ...
              onFocus={(e) =>
                (e.target.style.borderColor = errors.height
                  ? "var(--danger)"
                  : currentThemeColor)
              }
              onBlur={(e) =>
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                updateField(activeStep, "weight", e.target.value)
              }
              style={{
                padding: "12px 14px",
                borderRadius: "var(--radius-md)",
        ...
        <div style={{ display: "flex", gap: "12px" }}>
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                updateField(activeStep, "shoeSize", e.target.value)
              }
              style={{
                padding: "12px 14px",
                borderRadius: "var(--radius-md)",
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                updateField(activeStep, "shirtSize", e.target.value)
              }
              style={{
                padding: "12px 14px",
                borderRadius: "var(--radius-md)",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          ...
          <input
            ...
            onChange={(e) =>
              updateField(activeStep, "facebook", e.target.value)
            }
            style={{
              padding: "12px 14px",
              borderRadius: "var(--radius-md)",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          <label
            style={{ fontSize: "13px", fontWeight: 600, color: "var(--text)" }}
          >
            Sở thích (Phân tách bằng dấu phẩy)
          </label>
          <textarea
            ...
            onChange={(e) =>
              isBoyStep
                ? setInterestStr1(e.target.value)
                : setInterestStr2(e.target.value)
            }
            rows={2}
            style={{
              padding: "12px 14px",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          <label
            style={{ fontSize: "13px", fontWeight: 600, color: "var(--text)" }}
          >
            Ghét / Không thích (Phân tách bằng dấu phẩy)
          </label>
          <textarea
            ...
            onChange={(e) =>
              isBoyStep
                ? setDislikeStr1(e.target.value)
                : setDislikeStr2(e.target.value)
            }
            rows={2}
            style={{
              padding: "12px 14px",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          <label
            style={{ fontSize: "13px", fontWeight: 600, color: "var(--text)" }}
          >
            Cực kỳ ghét / Dị ứng (Phân tách bằng dấu phẩy)
          </label>
          <textarea
            ...
            onChange={(e) =>
              isBoyStep
                ? setHateStr1(e.target.value)
                : setHateStr2(e.target.value)
            }
            rows={2}
            style={{
              padding: "12px 14px",
